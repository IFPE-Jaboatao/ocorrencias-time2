# AGENTS.md — SGOA: Sistema de Gestão de Ocorrências Acadêmicas
...
[ ] AGENTS.md atualizado se novo hurdle ou padrão foi descoberto
...
- **Documente hurdles no AGENTS.md e features no DOC_EDUCATIVO.md** antes de fechar a sessão. O próximo contexto começa do zero; este arquivo é a memória que persiste.
...
Vive na raiz do projeto, ao lado do `AGENTS.md`. **O agente deve atualizar o
...
*Atualizar AGENTS.md a cada hurdle novo descoberto durante o desenvolvimento.*
...
| `docs` | Documentação: AGENTS.md, DOC_EDUCATIVO.md, Swagger, comentários |
...
conforme payload definido em §21.2 do AGENTS.md.
...
# Documentação
docs(Codex): adicionar H-16 graceful shutdown e RF-14/RF-15 ao AGENTS.md
